...
abstract class _DateTimeFormats {
  ...
  static final frappeFormat = DateFormat('YYYY-mm-dd');
...
abstract class DateFormatUtil {
  ...
  static String fromFrappeToddMMyyyy(String dateTime) =>
     _DateTimeFormats.friendlyFormat.format(_DateTimeFormats.frappeFormat.parse(dateTime));
  ...
  static String? toYYYYmmDDHHmmss(String? date, String? time) {
    if(date.doesNotHaveValue || time.doesNotHaveValue) return null;
    try {  
